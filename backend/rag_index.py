...
_ARMENIAN_SUFFIXES = (
    "ությունների", "ություններին", "ություններով", "ություններից", "ությունները",
    "ությունում", "ությունը", "ությունից", "ությունով", "ությանը", "ությամբ", "ություն", "ության",
    "ականների", "ականներին", "ականներով", "ականներից", "ականները", "ականներ", "ականին", "ականով", "ականից", "ականի", "ական",
    "այինների", "այիններին", "այիններով", "այիններից", "այինները", "այիններ", "այինին", "այինով", "այինից", "այինի", "ային",
    "ավորների", "ավորներին", "ավորներով", "ավորներից", "ավորները", "ավորներ", "ավորին", "ավորով", "ավորից", "ավորի", "ավոր",
    "ողների", "ողներին", "ողներով", "ողներից", "ողները", "ողներ", "ողին", "ողով", "ողից", "ողի", "ողը", "ող",
    "ատուների", "ատուներին", "ատուներով", "ատուներից", "ատուները", "ատուներ", "ատուին", "ատուի", "ատու",
