...
(function () {
  ...
  const T = {
    ...
    'home.btn_services': { hy: 'Դիտել ծառայությունները', en: 'View our services' },
    'home.btn_contact':  { hy: 'Կապնվել մեզ հետ', en: 'Contact Us' },
    'home.hero_title':   { hy: 'Թվային լուծումներ՝ հանուն մարդու բարեկեցության', en: 'Digital solutions<br>for human well-being' },
    'home.hero_presentation_text': { hy: 'Միասնական, մարդակենտրոն և վստահելի թվային միջավայր՝ յուրաքանչյուր քաղաքացու համար', en: 'A unified, people-centered and reliable digital environment for every citizen' },
    ...
    'svc.s3_text':   { hy: 'Կրթական ծրագրերի նախագծում և իրականացում', en: 'Design and implementation of educational programs' },
    ...
    'blog.featured_title':{ hy: 'Գործարկվել է «Աշխատանք առանց սահմանների» որոնման միասնական համակարգը', en: '"Work Without Borders" Unified Search System Launched' },
    ...
    /* Blog news article */
    'blog.news1_badge': { hy: 'Նորություն', en: 'News' },
    'blog.news1_excerpt': { hy: 'Աշխատանքի և սոցիալական հարցերի նախարար Արսեն Թորոսյանը մասնակցել է «WISE» հիմնադրամի վերաբրենդավորման և զարգացման տեսլականի քննարկմանը։', en: 'Minister of Labor and Social Affairs Arsen Torosyan joined the discussion on the WISE Foundation\'s rebranding and development vision.' },
    'blog.news1_title': { hy: '«WISE» բարեկեցության տեղեկատվական համակարգերի ձեռնարկություն հիմնադրամի վերաբրենդավորման և վերջին ամիսների իրականացված աշխատանքների և զարգացման տեսլականի ներկայացումը', en: 'Presentation of the WISE Welfare Information Systems Enterprise Foundation\'s rebranding, recent work and development vision' },
    'blog.news1_p1':    { hy: 'Աշխատանքի և սոցիալական հարցերի նախարար Արսեն Թորոսյանը մասնակցել է «WISE» բարեկեցության տեղեկատվական համակարգերի ձեռնարկություն հիմնադրամի (նախկին «Նորք» տեխնոլոգիաների կենտրոն) կողմից վերջին վեց ամիսների ընթացքում իրականացված աշխատանքների և զարգացման տեսլականի վերաբերյալ քննարկմանը։ Հանդիպմանը ներկա են եղել նաև ԱՍՀ նախարարի տեղակալ Արաիկ Եսայանը, «WISE» հիմնադրամի տնօրեն Արմինե Հովսեփյանը, ՄՍԾ պետի տեղակալներ Աննա Մկրտումյանը, Լիանա Թովմասյանը և Աննա Բեգլարյանը, ինչպես նաև ներկայացուցիչներ` Միավորված ազգերի կազմակերպության զարգացման ծրագրից (ՄԱԶԾ)։', en: 'Minister of Labor and Social Affairs Arsen Torosyan participated in the discussion on the work carried out over the past six months and the development vision of the WISE Welfare Information Systems Enterprise Foundation (formerly Norq Technology Center). The meeting was also attended by Deputy Minister Araik Yesayan, WISE Foundation Director Armine Hovsepyan, USS Deputy Heads Anna Mkrtumyan, Liana Tovmasyan and Anna Beglaryan, as well as representatives of the United Nations Development Programme (UNDP).' },
    'blog.news1_p2':    { hy: 'Ներկայացվել է հիմնադրամի զարգացման տեսլականը, նոր բրենդինգը, համաձայն որի` թվային ծառայությունների մատուցման ոլորտում կազմակերպության գործունեությունը ուղղված կլինի մարդակենտրոն, տվյալահեն և ժամանակակից թվային միջավայրի ձևավորմանը։', en: 'The foundation\'s development vision and new branding were presented, according to which the organization\'s activities in digital service delivery will be aimed at creating a human-centered, data-driven and modern digital environment.' },
    'blog.news1_p3':    { hy: 'Կարևորելով սոցիալական պաշտպանության համակարգը միասնական թվային միջավայրում համախմբելու գաղափարը՝ նախարար Արսեն Թորոսյանը նշել է, որ իրականացվող թվային փոխակերպումները միտված են ձևավորելու այնպիսի համակարգ, որտեղ մատուցվող ծառայությունները կլինեն ոչ միայն թվայնացված, այլև փոխկապակցված, մարդակենտրոն, հասանելի և արդյունավետ։', en: 'Emphasizing the idea of uniting the social protection system in a unified digital environment, Minister Arsen Torosyan noted that the ongoing digital transformations are aimed at building a system where the services provided will be not only digitized but also interconnected, human-centered, accessible and efficient.' },
    'blog.news1_p4':    { hy: 'Քննարկման ընթացքում ելույթներով հանդես են եկել նաև ԱՍՀ նախարարի տեղակալ Արաիկ Եսայանը, «WISE» հիմնադրամի տնօրեն Արմինե Հովսեփյանը, ՄՍԾ պետի տեղակալ Լիանա Թովմասյանը և Միավորված ազգերի կազմակերպության զարգացման ծրագրի նորարարության և կայուն ֆինանսավորման պորտֆելի ղեկավար Տիգրան Ճորոխյանը։', en: 'During the discussion, speeches were also delivered by Deputy Minister Araik Yesayan, WISE Foundation Director Armine Hovsepyan, USS Deputy Head Liana Tovmasyan, and UNDP Innovation and Sustainable Finance Portfolio Lead Tigran Chorokhyan.' },
    'blog.news1_p5':    { hy: '«WISE» հիմնադրամի աշխատակիցները ներկայացրել են միջազգային գործընկերների հետ համատեղ իրականացված ծրագրերը, ներդրվելիք թվային նոր գործիքներն ու նախաձեռնությունները։', en: 'WISE Foundation staff presented the programs implemented jointly with international partners, as well as the new digital tools and initiatives to be introduced.' },
    'blog.news1_p6':    { hy: 'Քննարկումը կազմակերպվել է Միավորված ազգերի կազմակերպության զարգացման ծրագրի աջակցությամբ` ԵՄ ֆինանսավորմամբ իրականացվող «Հայաստանի սոցիալական պաշտպանության համակարգի հզորացում» ծրագրի շրջանակում:', en: 'The discussion was organized with the support of the United Nations Development Programme within the framework of the EU-funded «Strengthening Armenia\'s Social Protection System» program.' },
    ...
    'svc.tag_infra': { hy: 'Ենթակառուցվածք', en: 'Infrastructure' },
    'svc.tag_content': { hy: 'Բովանդակություն', en: 'Content Support' },
    'svc.tag_analytics': { hy: 'Վերլուծություն', en: 'Analytics' },
    'svc.tag_edu': { hy: 'Կրթություն', en: 'Education' },
    'svc.tag_sec': { hy: 'Կիբեռանվտանգություն', en: 'Cybersecurity' },
    'svc.status_active': { hy: 'Շահագործման մեջ', en: 'Active' },
    'svc.proj1_title': { hy: 'Տարեցների հերթագրման համակարգ', en: 'Elderly Queue Registration System' },
    'svc.proj1_desc': { hy: 'Տարեց քաղաքացիների և խնամքի ծառայությունների հերթագրման ու դիմումների էլեկտրոնային կառավարում։', en: 'Electronic queue management and application processing for senior citizens care services.' },
    'svc.proj2_title': { hy: 'Անապահովության գնահատման համակարգ', en: 'Vulnerability Assessment System' },
    'svc.proj2_desc': { hy: 'Ընտանիքների անապահովության գնահատման և նպաստների նշանակման միասնական թվային հարթակ։', en: 'Unified digital platform for family vulnerability assessment and social benefit assignments.' },
    'svc.proj3_title': { hy: 'Կենսաթոշակի հաշվիչ', en: 'Pension Calculator' },
    'svc.proj3_desc': { hy: 'Աշխատանքային ստաժի և տարիքային կենսաթոշակի չափի ավտոմատացված առցանց հաշվարկման գործիք։', en: 'Automated online calculator for work experience and age pension estimation.' },
    ...
    'contact.address_val': { hy: 'Հայաստան, Երևան, Կ․ Ուլնեցի 68', en: 'Armenia, Yerevan, K. Ulnetsi 68' },
    ...
    'part.p3': { hy: 'Աշխատանքի և սոցիալական հետազոտությունների ազգային ինստիտուտ', en: 'National Institute of Labor and Social Research' },
    ...
    'faq.search_ph':   { hy: 'Որոնել հարցերի մեջ...', en: 'Search frequently asked questions...' },
    'faq.no_results':   { hy: 'Համապատասխան հարցեր չեն գտնվել', en: 'No matching questions found' },
    ...
    'careers.perks_eyebrow': { hy: 'Առավելություններ', en: 'Perks & Benefits' },
    'careers.perks_title': { hy: 'Ինչ ենք առաջարկում մեր թիմին', en: 'What We Offer Our Team' },
    'careers.perks_subtitle': { hy: 'Ստեղծում ենք հարմարավետ և ոգեշնչող պայմաններ յուրաքանչյուր մասնագետի համար։', en: 'Creating comfortable and inspiring conditions for every professional.' },
    'careers.perk1_title': { hy: 'Առողջապահական ապահովագրություն', en: 'Health Insurance' },
    'careers.perk1_text': { hy: 'Համապարփակ բժշկական ապահովագրության փաթեթ աշխատակիցների և նրանց ընտանիքների համար։', en: 'Comprehensive health insurance package for team members and families.' },
    'careers.perk2_title': { hy: 'Մասնագիտական աճ', en: 'Professional Growth' },
    'careers.perk2_text': { hy: 'Մասնակցություն միջազգային դասընթացների, կոնֆերանսների և շարունակական կրթության ծրագրերի։', en: 'Participation in international courses, conferences, and continuous education programs.' },
    'careers.perk3_title': { hy: 'Ժամանակակից տեխնիկա', en: 'Modern Equipment' },
    'careers.perk3_text': { hy: 'Առաջատար սարքավորումներ և ժամանակակից աշխատանքային գործիքներ բարձր արտադրողականության համար։', en: 'State-of-the-art workstations and modern development tools for maximum productivity.' },
    'careers.perk4_title': { hy: 'Հավասարակշռված միջավայր', en: 'Balanced Culture' },
    'careers.perk4_text': { hy: 'Աշխատանք-կյանք հավասարակշռություն, աջակցող թիմային մշակույթ և ընդարձակ հանգստի գոտի։', en: 'Work-life balance, supportive peer culture, and spacious collaboration zones.' },
    ...
    'careers.openings_title': { hy: 'Մենք փնտրում ենք', en: 'We are looking for' },
    ...
    'careers.details':     { hy: 'Մանրամասներ', en: 'Details' },
    'careers.hide':        { hy: 'Թաքցնել', en: 'Hide' },
    'careers.duties_title':{ hy: 'Պարտականություններ', en: 'Responsibilities' },
    'careers.soft_title':  { hy: 'Անհրաժեշտ փափուկ հմտություններ', en: 'Required soft skills' },
    'careers.req_title':   { hy: 'Պահանջներ', en: 'Requirements' },
    'careers.info_title':  { hy: 'Տեղեկություն հաստիքի մասին', en: 'Position information' },
    'careers.job4_dep_t':  { hy: 'Բաժինը', en: 'Department' },
    'careers.job4_dep':    { hy: 'Իրավական և վարչատնտեսական', en: 'Legal and Administrative' },
    'careers.job4_sub_t':  { hy: 'Ենթակայությունը', en: 'Reports to' },
    'careers.job4_sub':    { hy: 'Վարչատնտեսական գծով ղեկավար', en: 'Head of Administrative Affairs' },
    'careers.job4_fmt_t':  { hy: 'Աշխատանքի ձևաչափը', en: 'Work format' },
    'careers.job4_fmt':    { hy: 'գրասենյակից, ք. Երևան', en: 'On-site, Yerevan' },
    'careers.job4_title':  { hy: 'Տնտեսվար - բանվոր', en: 'Caretaker - Worker' },
    'careers.job4_meta':   { hy: 'Բաժինը՝ Իրավական և վարչատնտեսական · Երևան', en: 'Department: Legal and Administrative · Yerevan' },
    'careers.job4_text':   { hy: 'Տնտեսվար-բանվորն աջակցում է կազմակերպության վարչատնտեսական գործունեությանը՝ ապահովելով գույքի, տարածքների և նյութական միջոցների պատշաճ սպասարկումը, տեղափոխումը։', en: 'The caretaker-worker supports the organization\'s administrative and economic activity, ensuring proper maintenance and transportation of property, premises and materials.' },
    'careers.job4_summary_title': { hy: 'Աշխատանքի համառոտ նկարագրություն', en: 'Brief job description' },
    'careers.job4_summary':{ hy: 'Տնտեսվար-բանվորն աջակցում է կազմակերպության վարչատնտեսական գործունեությանը՝ ապահովելով գույքի, տարածքների և նյութական միջոցների պատշաճ սպասարկումը, տեղափոխումը։', en: 'The caretaker-worker supports the organization\'s administrative and economic activity, ensuring proper maintenance and transportation of property, premises and materials.' },
    'careers.job4_d1':     { hy: 'Հայտնաբերել տարածքում առաջացած տեխնիկական անսարքությունները և վերացնել (լամպերի փոխում, դռների և պատուհանների պարզ վերանորոգում և այլն)։', en: 'Detect and fix technical faults on the premises (replacing lamps, simple repair of doors and windows, etc.).' },
    'careers.job4_d2':     { hy: 'Մասնակցել կահույքի և սարքավորումների տեղափոխման, տեղադրման աշխատանքներին։', en: 'Participate in moving and installing furniture and equipment.' },
    'careers.job4_d3':     { hy: 'Աջակցել միջոցառումների նախապատրաստման և ավարտից հետո տարածքի կարգի բերման աշխատանքներին։', en: 'Support event preparation and tidying of the premises afterwards.' },
    'careers.job4_d4':     { hy: 'Ապահովել դիսպենսերներում ջրի առկայությունը։', en: 'Ensure water is available in dispensers.' },
    'careers.job4_d5':     { hy: 'Կատարել անմիջական ղեկավարի կողմից տրված պաշտոնից բխող այլ հանձնարարություններ։', en: 'Carry out other job-related tasks assigned by the immediate supervisor.' },
    'careers.job4_s1_t':   { hy: 'Պատասխանատվություն', en: 'Responsibility' },
    'careers.job4_s1_d':   { hy: 'վստահված գույքի և աշխատանքի նկատմամբ պատասխանատու մոտեցում։', en: 'a responsible approach to entrusted property and work.' },
    'careers.job4_s2_t':   { hy: 'Կարգապահություն', en: 'Discipline' },
    'careers.job4_s2_d':   { hy: 'աշխատանքային կանոնների պահպանման կարողություն։', en: 'the ability to follow work rules.' },
    'careers.job4_s3_t':   { hy: 'Թիմային աշխատանք', en: 'Teamwork' },
    'careers.job4_s3_d':   { hy: 'թիմի հետ համագործակցելու պատրաստակամություն։', en: 'a willingness to cooperate with the team.' },
    'careers.job4_r1':     { hy: 'Միջին կամ միջին մասնագիտական կրթություն։', en: 'Secondary or vocational education.' },
    'careers.job4_r2':     { hy: 'Նախընտրելի է աշխատանքային փորձ վարչատնտեսական կամ սպասարկման ոլորտում։', en: 'Work experience in administrative or maintenance field is preferred.' },
    'careers.job4_r3':     { hy: 'Ֆիզիկական աշխատանքի պատրաստակամություն։', en: 'Readiness for physical work.' },
    'careers.job4_r4':     { hy: 'Պատասխանատվություն և կարգապահություն։', en: 'Responsibility and discipline.' },
    'careers.job1_summary_title': { hy: 'Աշխատանքի համառոտ նկարագրություն', en: 'Brief job description' },
    'careers.job1_summary':{ hy: 'Մենք փնտրում ենք փորձառու Full Stack մշակող՝ մեր սոցիալական ծառայությունների նախագծերի համար։ Դուք կաշխատեք ժամանակակից տեխնոլոգիական ստեկով և կմասնակցեք պետական ոլորտի կարևորագույն նախագծերի մշակմանը։', en: 'We are looking for an experienced Full Stack developer for our social services projects. You will work with a modern technology stack and take part in developing key public-sector projects.' },
    'careers.job2_summary_title': { hy: 'Աշխատանքի համառոտ նկարագրություն', en: 'Brief job description' },
    'careers.job2_summary':{ hy: 'Դիզայներ, որը մարդկանց համար կդարձնի հանրային ծառայությունները պարզ և հաճելի։ Կմշակեք ինտերֆեյսներ և օգտագործողի փորձ պետական թվային ծառայությունների համար։', en: 'A designer who will make public services simple and pleasant for people. You will design interfaces and user experience for public digital services.' },
    'careers.job3_summary_title': { hy: 'Աշխատանքի համառոտ նկարագրություն', en: 'Brief job description' },
    'careers.job3_summary':{ hy: 'Մեր համակարգերի որակի և հուսալիության պատասխանատու՝ ավտոմատացված և մեխանիկական թեստավորում։ Կապահովեք ծրագրային արտադրանքի որակը ողջ կյանքի ցիկլի ընթացքում։', en: 'Responsible for the quality and reliability of our systems through automated and manual testing. You will ensure software product quality throughout the whole lifecycle.' },
    'careers.cv_title':    { hy: 'Չեք գտե՞լ Ձեզ հարմար հաստիք', en: 'No position that fits?' },
    'careers.cv_text':     { hy: 'Ուղարկեք Ձեր ինքնակենսագրությունը, և կապ կհաստատենք առկա հաստիքների դեպքում', en: 'Send your CV and we will contact you when a suitable position becomes available' },
  ...
  const RU = {
    ...
    'home.btn_services': 'Смотреть услуги',
    ...
    'svc.s3_text': 'Проектирование и реализация образовательных программ',
    ...
    'about.num_stat3': 'Официальные сайты',
    ...
    'footer.copyright': '© 2026 Дизайн фонда «WISE»',
    ...
    'blog.news1_badge': 'Новость',
    'blog.news1_excerpt': 'Министр труда и социальных вопросов Арсен Торосян принял участие в обсуждении ребрендинга и видения развития фонда «WISE».',
    'blog.news1_title': 'Презентация ребрендинга, работ последних месяцев и видения развития фонда «WISE» — «Предприятие информационных систем благосостояния»',
    'blog.news1_p1': 'Министр труда и социальных вопросов Арсен Торосян принял участие в обсуждении работ, выполненных за последние шесть месяцев, и видения развития фонда «WISE» — «Предприятие информационных систем благосостояния» (бывший технологический центр «Норк»). На встрече также присутствовали заместитель министра Араик Есаян, директор фонда «WISE» Армине Овсепян, заместители начальника ЕСС Анна Мкртумян, Лиана Товмасян и Анна Бегларян, а также представители Программы развития Организации Объединённых Наций (ПРООН).',
    'blog.news1_p2': 'Были представлены видение развития фонда и новый брендинг, согласно которому деятельность организации в сфере цифровых услуг будет направлена на формирование человекоцентричной, основанной на данных и современной цифровой среды.',
    'blog.news1_p3': 'Подчеркнув идею объединения системы социальной защиты в единой цифровой среде, министр Арсен Торосян отметил, что проводимые цифровые преобразования направлены на создание такой системы, в которой услуги будут не только оцифрованы, но и взаимосвязаны, человекоцентричны, доступны и эффективны.',
    'blog.news1_p4': 'В ходе обсуждения выступили также заместитель министра Араик Есаян, директор фонда «WISE» Армине Овсепян, заместитель начальника ЕСС Лиана Товмасян и руководитель портфеля инноваций и устойчивого финансирования ПРООН Тигран Чорохян.',
    'blog.news1_p5': 'Сотрудники фонда «WISE» представили программы, реализованные совместно с международными партнёрами, а также новые цифровые инструменты и инициативы, которые будут внедрены.',
    'blog.news1_p6': 'Обсуждение было организовано при поддержке Программы развития ООН в рамках финансируемой ЕС программы «Укрепление системы социальной защиты Армении».',
    ...
    'svc.tag_infra': 'Инфраструктура',
    'svc.tag_content': 'Контент',
    'svc.tag_analytics': 'Аналитика',
    'svc.tag_edu': 'Образование',
    'svc.tag_sec': 'Кибербезопасность',
    'svc.status_active': 'В эксплуатации',
    'svc.proj1_title': 'Система записи пожилых граждан',
    'svc.proj1_desc': 'Электронное управление очередями и заявлениями на услуги по уходу за пожилыми гражданами.',
    'svc.proj2_title': 'Система оценки уязвимости',
    'svc.proj2_desc': 'Единая цифровая платформа для оценки уязвимости семей и назначения пособий.',
    'svc.proj3_title': 'Пенсионный калькулятор',
    'svc.proj3_desc': 'Инструмент автоматического онлайн-расчёта трудового стажа и размера пенсии по возрасту.',
    ...
    'contact.address_val': 'Армения, Ереван, К. Улнеци 68',
    ...
    'part.p24': 'Фонд инкубатор предприятий (Enterprise Incubator Foundation)',
    'part.p25': 'ID Bank',
    ...
    'chat.disclaimer': 'Информационно · Для официального решения: 114',
    ...
    'faq.search_ph': 'Поиск по частым вопросам...',
    'faq.no_results': 'Совпадающих вопросов не найдено',
    ...
    'careers.perks_eyebrow': 'Преимущества',
    'careers.perks_title': 'Что мы предлагаем нашей команде',
    'careers.perks_subtitle': 'Создаём комфортные и вдохновляющие условия для каждого специалиста.',
    'careers.perk1_title': 'Медицинская страховка',
    'careers.perk1_text': 'Комплексный пакет медицинского страхования для сотрудников и их семей.',
    'careers.perk2_title': 'Профессиональный рост',
    'careers.perk2_text': 'Участие в международных курсах, конференциях и программах непрерывного обучения.',
    'careers.perk3_title': 'Современная техника',
    'careers.perk3_text': 'Передовое оборудование и современные рабочие инструменты для высокой продуктивности.',
    'careers.perk4_title': 'Баланс и культура',
    'careers.perk4_text': 'Баланс работы и личной жизни, поддерживающая командная культура и просторные зоны отдыха.',
    ...
    'careers.details': 'Подробнее',
    'careers.hide': 'Скрыть',
    'careers.duties_title': 'Обязанности',
    'careers.soft_title': 'Необходимые личные качества',
    'careers.req_title': 'Требования',
    'careers.info_title': 'Информация о должности',
    'careers.job4_dep_t': 'Отдел',
    'careers.job4_dep': 'правовой и административно-хозяйственный',
    'careers.job4_sub_t': 'Подчинение',
    'careers.job4_sub': 'руководитель по административно-хозяйственной части',
    'careers.job4_fmt_t': 'Формат работы',
    'careers.job4_fmt': 'в офисе, г. Ереван',
    'careers.job4_title': 'Завхоз - рабочий',
    'careers.job4_meta': 'Отдел: правовой и административно-хозяйственный · Ереван',
    'careers.job4_text': 'Завхоз-рабочий поддерживает административно-хозяйственную деятельность организации, обеспечивая надлежащее обслуживание и перемещение имущества, помещений и материальных средств.',
    'careers.job4_summary_title': 'Краткое описание работы',
    'careers.job4_summary': 'Завхоз-рабочий поддерживает административно-хозяйственную деятельность организации, обеспечивая надлежащее обслуживание и перемещение имущества, помещений и материальных средств.',
    'careers.job4_d1': 'Выявлять и устранять технические неисправности в помещениях (замена ламп, простой ремонт дверей и окон и т.д.).',
    'careers.job4_d2': 'Участвовать в перемещении и установке мебели и оборудования.',
    'careers.job4_d3': 'Содействовать подготовке мероприятий и приведению помещений в порядок после их завершения.',
    'careers.job4_d4': 'Обеспечивать наличие воды в диспенсерах.',
    'careers.job4_d5': 'Выполнять другие поручения непосредственного руководителя, вытекающие из должности.',
    'careers.job4_s1_t': 'Ответственность',
    'careers.job4_s1_d': 'ответственный подход к вверенному имуществу и работе.',
    'careers.job4_s2_t': 'Дисциплинированность',
    'careers.job4_s2_d': 'способность соблюдать трудовые правила.',
    'careers.job4_s3_t': 'Работа в команде',
    'careers.job4_s3_d': 'готовность сотрудничать с командой.',
    'careers.job4_r1': 'Среднее или среднее профессиональное образование.',
    'careers.job4_r2': 'Желателен опыт работы в административно-хозяйственной или обслуживающей сфере.',
    'careers.job4_r3': 'Готовность к физической работе.',
    'careers.job4_r4': 'Ответственность и дисциплинированность.',
    'careers.job1_summary_title': 'Краткое описание работы',
    'careers.job1_summary': 'Мы ищем опытного Full Stack разработчика для наших проектов в сфере социальных услуг. Вы будете работать с современным технологическим стеком и участвовать в разработке ключевых проектов государственного сектора.',
    'careers.job2_summary_title': 'Краткое описание работы',
    'careers.job2_summary': 'Дизайнер, который сделает государственные услуги простыми и удобными для людей. Вы будете разрабатывать интерфейсы и пользовательский опыт для государственных цифровых услуг.',
    'careers.job3_summary_title': 'Краткое описание работы',
    'careers.job3_summary': 'Ответственный за качество и надёжность наших систем: автоматизированное и ручное тестирование. Вы будете обеспечивать качество программного продукта на протяжении всего жизненного цикла.',
    'careers.cv_title': 'Не нашли подходящую должность?',
    'careers.cv_text': 'Отправьте резюме, и мы свяжемся с вами при появлении подходящей должности',
