...
(function () {
  ...
  const T = {
    ...
    'svc.p7_title': { hy: 'Domestic Violence Registration IS', en: 'Domestic Violence Registration IS' },
    'svc.p7_text': { hy: 'Centralized registration system for domestic violence cases.', en: 'Centralized registration system for domestic violence cases.' },
    'svc.p8_title': { hy: 'Housing Support for Displaced Families IS', en: 'Housing Support for Displaced Families IS' },
    'svc.p8_text': { hy: 'Management system for state housing support program for displaced families.', en: 'Management system for state housing support program for displaced families.' },
    'svc.p9_title': { hy: 'Urgent Response Platform', en: 'Urgent Response Platform' },
    'svc.p9_text': { hy: 'www.hratapkariq.am - platform for urgent social response.', en: 'www.hratapkariq.am - platform for urgent social response.' },
    'svc.p10_title': { hy: 'Civil Servants Attestation IS', en: 'Civil Servants Attestation IS' },
    'svc.p10_text': { hy: 'IS for civil servants attestation questionnaires (2010).', en: 'IS for civil servants attestation questionnaires (2010).' },
    'svc.p11_title': { hy: 'Integrated Social Services Reception IS', en: 'Integrated Social Services Reception IS' },
    'svc.p11_text': { hy: 'Unified application registration system for integrated social services.', en: 'Unified application registration system for integrated social services.' },
    'svc.p12_title': { hy: 'Senior Citizens and Disabled Registration IS', en: 'Senior Citizens and Disabled Registration IS' },
    'svc.p12_text': { hy: 'Registration of senior citizens and disabled persons in social programs.', en: 'Registration of senior citizens and disabled persons in social programs.' },
    'svc.p13_title': { hy: 'Pyunik Disability Registration IS', en: 'Pyunik Disability Registration IS' },
    'svc.p13_text': { hy: 'Registration system for persons applying for disability status.', en: 'Registration system for persons applying for disability status.' },
    'svc.p14_title': { hy: 'Charitable Programs Registration IS', en: 'Charitable Programs Registration IS' },
    'svc.p14_text': { hy: 'IS with 3 subsystems: programs, needs, and charity receipt.', en: 'IS with 3 subsystems: programs, needs, and charity receipt.' },
    'svc.p15_title': { hy: 'Social Housing Fund Registration IS', en: 'Social Housing Fund Registration IS' },
    'svc.p15_text': { hy: 'IS for housing registration and waiting list (2014).', en: 'IS for housing registration and waiting list (2014).' },
    'svc.p16_title': { hy: 'Social Case Management IS', en: 'Social Case Management IS' },
    'svc.p16_text': { hy: 'Automation of social case management process.', en: 'Automation of social case management process.' },
    'svc.p17_title': { hy: 'USSR Savings Bank Compensation IS', en: 'USSR Savings Bank Compensation IS' },
    'svc.p17_text': { hy: 'Compensation system for pre-1993 USSR Savings Bank deposits.', en: 'Compensation system for pre-1993 USSR Savings Bank deposits.' },
    'svc.p18_title': { hy: 'Npast Family Vulnerability Assessment IS', en: 'Npast Family Vulnerability Assessment IS' },
    'svc.p18_text': { hy: 'Automated system for family vulnerability assessment scoring.', en: 'Automated system for family vulnerability assessment scoring.' },
    
    'svc.details_label': { hy: 'Service Details', en: 'Service Details' },
    'svc.details_title': { hy: 'What We Provide', en: 'What We Provide' },
    'svc.sd1_title': { hy: 'IS Design and Maintenance', en: 'IS Design and Maintenance' },
    'svc.sd1_intro': { hy: 'IT project management: PMBoK, Agile', en: 'IT project management: PMBoK, Agile' },
    'svc.sd1_l1': { hy: 'Back-End: PHP, C# ASP.NET WCF (Yii, React)', en: 'Back-End: PHP, C# ASP.NET WCF (Yii, React)' },
    'svc.sd1_l2': { hy: 'Databases: MySQL, PostgreSQL, Oracle', en: 'Databases: MySQL, PostgreSQL, Oracle' },
    'svc.sd1_l3': { hy: 'Front-End: HTML/CSS/JS (BootStrap)', en: 'Front-End: HTML/CSS/JS (BootStrap)' },
    'svc.sd2_title': { hy: 'IS Content Maintenance', en: 'IS Content Maintenance' },
    'svc.sd2_text': { hy: 'Data processing, analysis and content support with quality control.', en: 'Data processing, analysis and content support with quality control.' },
    'svc.sd3_title': { hy: 'Data Processing and Analysis', en: 'Data Processing and Analysis' },
    'svc.sd3_text': { hy: 'Data collection, processing, analysis and report preparation.', en: 'Data collection, processing, analysis and report preparation.' },
    'svc.sd4_title': { hy: 'Educational Programs Design', en: 'Educational Programs Design' },
    'svc.sd4_text': { hy: 'Training on IS used in social service delivery.', en: 'Training on IS used in social service delivery.' },
    'svc.sd5_title': { hy: 'Cybersecurity and Network Support', en: 'Cybersecurity and Network Support' },
    'svc.sd5_text': { hy: 'Information security, network infrastructure protection.', en: 'Information security, network infrastructure protection.' },
    'svc.sd6_title': { hy: 'Computer and Equipment Maintenance', en: 'Computer and Equipment Maintenance' },
    'svc.sd6_text': { hy: 'Computer diagnostics, installation, software setup: 13,000+ units.', en: 'Computer diagnostics, installation, software setup: 13,000+ units.' },
